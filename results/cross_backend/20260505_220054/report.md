# Cross-Backend Round-Trip Study --- `20260505_220054`

## Setup

- Corpus: 200 synthetic Gaussian vectors
- Dimension: 128
- Random seed: 42
- Noise level (where applicable): 0.01
- Backends evaluated: faiss_flat, faiss_hnsw, chroma, qdrant_f32, qdrant_q8
...
| Technique | faiss_flat | faiss_hnsw | chroma | qdrant_f32 | qdrant_q8 |
|---|---:|---:|---:|---:|---:|
| clean | 1.0000 | 1.0000 | 1.0000 | 1.0000 | 1.0000 |
| noise | 0.9938 | 0.9938 | 0.9938 | 0.9938 | 0.9938 |
| rotation | 0.9999 | 0.9999 | 0.9999 | 0.9999 | 0.9999 |
| scaling | 1.0000 | 1.0000 | 1.0000 | 1.0000 | 1.0000 |
| offset | 0.9508 | 0.9508 | 0.9508 | 0.9508 | 0.9508 |
...
| noise | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 |
| rotation | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 |
| scaling | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 |
| offset | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 |
