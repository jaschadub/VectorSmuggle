...
from analysis.detection_signatures import StatisticalSignatureGenerator, PatternSignatureGenerator, BehavioralSignatureGenerator
from analysis.forensic_tools import EvidenceCollector, TimelineReconstructor, ArtifactAnalyzer
...
def test_statistical_detection(detector, test_vectors, logger):
    ...
    try:
        ...
        baseline_result = detector.establish_baseline(np.array(clean_vectors), "test_baseline")
