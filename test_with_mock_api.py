    ...
    with patch('langchain_openai.OpenAIEmbeddings') as mock_embeddings_class:
        ...
        with patch.dict(os.environ, {'OPENAI_API_KEY': 'sk-mock-key-for-testing'}):
            try:
                ...
                logger.info(f"✅ Data mixing successful:")
...
def test_detection_systems_comprehensive(logger):
    ...
    try:
        from analysis.detection_signatures import StatisticalSignatureGenerator, PatternSignatureGenerator
    ...
    with patch('langchain_openai.OpenAIEmbeddings') as mock_embeddings_class:
        ...
        with patch.dict(os.environ, {'OPENAI_API_KEY': 'sk-mock-key-for-testing'}):
            try:
                ...
                logger.info(f"✅ End-to-end workflow complete:")
